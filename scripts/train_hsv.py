"""
train_hsv.py - Training dan evaluasi menggunakan fitur warna HSV
"""
...
# Constants
HIST_BINS = 16
HSV_DIM = 54  # 3 channels * (2 mean/std + 16 bins)
...
def load_dataset(data_dir, hist_bins=16):
    """Load dataset dan ekstrak fitur HSV."""
    feature_names = []
    for ch in ['H', 'S', 'V']:
    ...
    for class_dir in Path(data_dir).iterdir():
        ...
        for img_file in class_dir.iterdir():
            ...
            try:
                ...
                features = extract_hsv_features(img, hist_bins)
...
def main():
    print("=" * 80)
    print("TRAINING MENGGUNAKAN FITUR WARNA HSV")
    print("=" * 80)
    print()
